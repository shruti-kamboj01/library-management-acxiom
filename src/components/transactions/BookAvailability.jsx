      ...
      <div className="flex flex-col text-center ">
        ...
        {showForm ? (
          <div>
            <div className="flex flex-col space-y-4 mt-4">
              <div className="grid grid-flow-col grid-cols-2 px-8">
                ...
                <select
                  ...
                  onChange={(val) => {
                    ...
                    set_query((prev) => [val, prev[1]]);
                  }}
                >
                  <option value={null}>Select book name</option>
                  {available_books.map((book, i) => {
                    return (
                      <option key={i} className="text-black" value={book}>
                        {book}
                      </option>
                    );
                  })}
              ...
              <div className="grid grid-flow-col grid-cols-2 px-8">
                ...
                <select
                  ...
                  onChange={(val) => {
                    val = val.target.value;
                    set_query((prev) => [prev[0], val]);
                  }}
                >
                  <option value={null}>Select author</option>
                  {available_authors.map((author, i) => {
                    return (
                      <option key={i} className="text-black" value={author}>
                        {author}
                      </option>
                    );
                  })}
            ...
            <button
              className="btn btn-sm w-[20%] self-end mt-4 mr-8 "
